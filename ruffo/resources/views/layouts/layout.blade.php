                ...
                <div class="sub-left-menu scroll">
                    <ul class="nav nav-list">
                        ...
                        <li class="active ripple">
                            <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Admin 
                            <span class="fa-angle-right fa right-arrow text-right"></span>
                            </a>
                            <ul class="nav nav-list tree">
                                <li><a href="{{ route('admin.index') }}">Usuarios</a></li>
                            </ul>
                        </li>
                        <li class="ripple">
                        ...
                        <li class="ripple">
                            <a class="tree-toggle nav-header"><span class="fa fa-file-code-o"></span> Pages  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                            <ul class="nav nav-list tree">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
              ...
              $(".btn-flip").on("click",function(){
                        $(this).find(".flip").animate().replaceWith("<span class='fa fa-check'></span>");
                    });
            });
        </script>
        <!-- end: Javascript -->
